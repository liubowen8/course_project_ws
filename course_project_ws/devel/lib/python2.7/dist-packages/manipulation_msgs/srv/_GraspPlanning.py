...
class GraspPlanningRequest(genpy.Message):
  ...
  _full_text = """# Requests that grasp planning be performed on the object to be grasped
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.target.region.cloud.is_dense
      buff.write(_get_struct_B().pack(_x))
      length = len(self.target.region.mask)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.target.region.mask))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.target.region.cam_info.D))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.arm_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.target.reference_frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.target.cluster.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.target.region.cloud.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.target.region.mask = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.target.region.image.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.target.region.image.encoding = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.target.region.disparity_image.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.target.region.disparity_image.encoding = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.target.region.cam_info.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.target.region.cam_info.distortion_model = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.target.region.cam_info.D = s.unpack(str[start:end])
      start = end
      end += 72
      ...
      if python3:
        self.target.region.roi_box_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.target.collision_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.collision_object_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.collision_support_surface_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.grasps:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*_v241.position))
        length = len(_v241.velocity)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*_v241.velocity))
        length = len(_v241.effort)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*_v241.effort))
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*_v244.position))
        length = len(_v244.velocity)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*_v244.velocity))
        length = len(_v244.effort)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*_v244.effort))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v263.position = s.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v263.velocity = s.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v263.effort = s.unpack(str[start:end])
        ...
        _v266.position = s.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v266.velocity = s.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v266.effort = s.unpack(str[start:end])
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v314.frame_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
